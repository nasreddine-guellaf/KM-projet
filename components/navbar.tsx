    ...
    <>
      ...
      >
        <Link href="/" className="flex items-center space-x-2">
          <Image src="/images/w27-logo.png" alt="W27 Logo" width={100} height={40} className="h-10 w-auto" />
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <NavLink href="/ressources/filieres">
            <Image src="/images/w27-logo.png" alt="W27 Logo" width={16} height={16} className="w-4 h-4 mr-1" />
            Ressources
          </NavLink>
          <NavLink href="/forums">
        ...
        <div className="md:hidden fixed inset-0 bg-white z-40 pt-20">
          <div className="flex flex-col items-center space-y-6 p-6">
            ...
            <MobileNavLink href="/ressources/filieres" onClick={toggleMenu}>
              <Image src="/images/w27-logo.png" alt="W27 Logo" width={20} height={20} className="w-5 h-5 mr-2" />
              Ressources
            </MobileNavLink>
